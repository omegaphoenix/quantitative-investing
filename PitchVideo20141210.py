# This file tests our strategy for the past one year
import math
import numpy as np
import pandas as pd
...
portfolio_20141110.rename(columns={'Symbol': 'Ticker', 'QTY': 'nShare', 'Price Paid': 'Price'})

PlotFolder = 'E:\Dropbox\CQA 2014\Plots'
CAPITAL = 1e7
...
anal_res.to_excel(r'%s\Portfolio_Analysis.xlsx' % DataFolder,
                    index=False)
